...
def RESTART():
    efface_tout()
    texte(largeur_Fenetre//2, hauteur_Fenetre//2-150, "Voulez-vous rejouer ?", ancrage='center', police=game_font, taille=35, couleur='black', tag='restart-text')
    ...
    texte(largeur_Fenetre//2-300, hauteur_Fenetre//2, "Oui", ancrage='center', police=game_font, taille=25, couleur='black', tag='restart-yes-text')
    ...
    texte(largeur_Fenetre//2+300, hauteur_Fenetre//2, "Non", ancrage='center', police=game_font, taille=25, couleur='black', tag='restart-no-text')
    isRestart = None
