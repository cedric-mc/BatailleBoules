...
def scores(dico_j1, dico_j2):
    ...
    txt1 = texte(150, 50, "Score : " + str(rouge), couleur='red', police="Monocraft", ancrage="center")
    r2 = rectangle(largeur_Fenetre-300, 0, largeur_Fenetre, 100, remplissage='white', epaisseur=3)
    txt2 = texte(largeur_Fenetre-150, 50, "Score : " + str(bleu), couleur='blue', police="Monocraft", ancrage="center")
    mise_a_jour()
    sleep(2)
...
def taille_des_boules(banque, color):
    ...
    texte(largeur_Fenetre//2, hauteur_Fenetre//3, "Entrer le nombre de pixels pour déterminer le rayon du cercle à poser (rayon par défaut 50) :", taille=20, couleur=color, police="Monocraft", ancrage='center', tag='demande')
