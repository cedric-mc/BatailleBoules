...
def melangeur_colors(color1, color2):
    """Cette fonction permet de mélanger les couleurs des joueurs. Les mélanges sont pré-définis.
    ...
    Returns:
        _type_ (str): Retourne la couleur mélangée.
    """
...
def choose_colors(x, y):
    ...
    Returns:
        color1 (str): Couleur du joueur 1.
        color2 (str): Couleur du joueur 2.
        isColors (bool): Renvoie si les couleurs ont été choisies.
    """
